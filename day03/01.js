...
// processOrder(1500, 4, console.log);
...
// const order = processOrder(2500, 30, (result) => {
//     return result >= 50000 ? true : false;
// });
...
processOrder(50000, 2, (result) => {
    return console.log(result * 0.9 + "걸제 완료");
});
