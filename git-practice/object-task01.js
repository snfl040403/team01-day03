...
blacksmith.skill = 15;
blacksmith.repair = function (sword) {
    blacksmith.stamina -= 5;
    sword.durability += blacksmith.skill;
    if (sword.durability >= 100) {
        sword.durability = 100;
        sword.isBrokene = false;
        return sword;
    }
    return sword;
};
...
for (i = 0; i < 3; i++) {
    console.log(blacksmith.repair(sword));
}
